...
async def search_persons(
    ...
    persons = await person_service.get_persons_with_pattern(
        pattern=pattern, page_size=page_size, page_number=page_number
    )
    return persons
...
async def search_films(
    ...
    films = await film_service.get_films_with_person(person_id=person_id, page_size=page_size, page_number=page_number)
    return films
