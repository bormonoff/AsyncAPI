...
async def search_genres(
    ...
    films = await genre_service.get_genres(page_size=page_size, page_number=page_number)
    return films
...
async def search_films_using_genre(
    ...
    genres = await genre_service.get_genres(genre_name=genre_name, page_size=page_size, page_number=page_number)
    return genres
